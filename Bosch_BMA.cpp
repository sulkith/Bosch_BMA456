...
//const uint8_t PROGMEM bma456_config_file[] = {
...
uint8_t FeaturesInConfig[] =
{
 //0x5E, will be included in the send command
 0x00,
 0x04,
 0xAA,
 //0x5E,
...
uint8_t writeConfigFile()
{
  ...
  uint16_t index = 0;
	...
	_delay_ms(1);
		...
		{
			uint8_t dataTemp[chunkSize] ={0};
			for(uint16_t i = 0; i<chunkSize; ++i)
			{
				dataTemp[i] = pgm_read_byte(&(bma456_config_file[index+i]));
			}
